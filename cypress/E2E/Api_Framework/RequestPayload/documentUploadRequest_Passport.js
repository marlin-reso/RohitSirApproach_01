...
describe('Test Passport document upload request API with valid data', () => {
    let apiData;
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'Passport document upload');
    ...
    filteredTestCases.forEach((testCase) => {
        it(`verify ${testCase.name} API with valid data`, () => {
            ...
            if (payLoad) {
                ...
                const filePaths = {
                    frontPage: 'Passport_01.png',
                    backPage: 'Passport_02.png',
                    
                  };
                const payload = JSON.stringify({ documentType: 'passport' }); // Adjust payload as needed
