...
describe(`Test Verify Email API`, () => {
    let apiData;
    before(function() {
    ...
    const invalidElectricityDetails = [
        ...
        {email: '12345678@scoreme.in', description: 'number as email username' },
        {email: '---------@scoreme.in',description: 'Hyfun as email username' },
        {email: '_________@scoreme.in',description: 'underscore as email username' },
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'Verify Email');
