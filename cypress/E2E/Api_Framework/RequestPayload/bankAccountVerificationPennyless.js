...
describe(`Test Bank Account Verification Pennyless API`, () => {
    let apiData;
    before(function() {
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'Bank Account Verification Pennyless');
