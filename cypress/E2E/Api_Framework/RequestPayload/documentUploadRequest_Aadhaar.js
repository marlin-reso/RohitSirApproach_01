...
describe('Test AAdhaar document upload request API with valid data', () => {
    let apiData;
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'Aadhaar document upload');
    ...
    filteredTestCases.forEach((testCase) => {
        it(`verify ${testCase.name} API with valid data`, () => {
            ...
            if (payLoad) {
                ...
                const filePaths = {
                    frontPage: 'AAAdhar_Mythili_Front.jpg',
                    backPage: 'AAAdhar_Mythili_Back.jpg',
                    
                  };
                const payload = JSON.stringify({ documentType: 'aadhaar' }); // Adjust payload as needed
