...
describe(`Test LEI Search API`, () => {
    ...
    const invalidentityName = [
        ...
        { entityName: '123456', description: 'Entity name is a number' },
        { entityName: undefined, description: 'Entity name is undefined' },
        { entityName: Boolean, description: 'Entity name is boolean' },
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'LEI Search');
