...
describe(`Test Udyam Assist verifiacation API`, () => {
    let apiData;
    before(function() {
    ...
    //All the commented test cases are passed only failed test cases are uncommented.

    const invalidregistrationnumber = [
    //    { registrationnumber: 'OD-07-7626153', description: 'Missing or invalid prefix in registration number' },
        { registrationnumber: 'UDYAm-i-XX-07-7626153', description: 'Non-existent registration number' },
    //     { registrationnumber: 'UDYAm_i_OD_07_7626153', description: 'Valid format registration number with underscore' },
    //     { registrationnumber: 'UDYAm-i-OD-07-7626', description: 'Too Short (missing digits)' },
    //     { registrationnumber: 'UDYAm-i-OD-07-762615333', description: 'Too Long (extra digits)' },
    //     { registrationnumber: 'UDYAm-i-OD-7-7626153', description: 'Missing leading zero in the code section' },
    //     { registrationnumber: 'UDYAm i OD 07 7626153', description: 'No hyphen between code and number' },
    //     { registrationnumber: 'UDYAm_i_XX_07-7626153', description: 'Underscores instead of hyphens' },
    //     { registrationnumber: 'UDYAm i OD 07 7626153', description: 'Spaces instead of hyphens' },
    //     { registrationnumber: 'UDYm-i-OD-07-7626153', description: 'Typo in the prefix' },
    //     { registrationnumber: 'UDYAms-i-OD-07-7626153', description: 'Extra character in the prefix' },
    //     { registrationnumber: 'UDYem-i-OD-07-7626153', description: 'Incorrect spelling of the prefix' },
    //     { registrationnumber: 'UDYAm-i-OD-07-7626153B', description: 'Alphanumeric digits in the registration number' },
    //     { registrationnumber: 'UDYAm-i-OD-07-762@6153', description: 'Special characters in the registration number' },
    //     { registrationnumber: 'UDYAm-i@-OD-07-7626153', description: 'Special character in the prefix section' },
    //     { registrationnumber: 'UDYAm-i-OD-0*-7626153', description: 'Special character in the code section' },
    //     { registrationnumber: 'UDYAm-i-OD-07-7626153%', description: 'Special character at the end of the registration number' },
    //     { registrationnumber: ' UDYAm-i-OD-07-7626153', description: 'Leading space' },
    //     { registrationnumber: 'UDYAm-i-OD-07-7626153 ', description: 'Trailing space' },
    //     { registrationnumber: 'UDYAm- i-OD-07-7626153', description: 'Space after prefix' },
    //     { registrationnumber: 'UDYAm-i-OD-07 -7626153', description: 'Space within the code section' },
    //     { registrationnumber: 'UDYAm -i-OD-07-7626153', description: 'Space after prefix with hyphen' },
    //     { registrationnumber: 'UDYAm-i-OD- 07-7626153', description: 'Space before code section' },
    //     { registrationnumber: 'UDYAm-i-OD-07-7626 153', description: 'Space within the number section' },
    //     { registrationnumber: 'UDYAm-i-OD-07-007626153', description: 'Trailing zero in the registration number' },
    //     { registrationnumber: 'UDYAm-li-OD-07-7626153', description: 'Non-existent region code' },
    //     { registrationnumber: 'UDYAm-iK-OD-07-7626153', description: 'Typo in the region code' },
    //   //  { registrationnumber: 'udyam-g-05-0041245', description: 'Single letter region code' },
    //     { registrationnumber: 'UDYAm-i!-OD-07-7626153', description: 'Special character in region code' },
    //     { registrationnumber: 'UDYAm-i1-OD-07-7626153', description: 'Numeric digit in region code' },
    //     { registrationnumber: 'UDYAm-9-164-07-7626153', description: 'All numeric region code' },
    //     { registrationnumber: 'UDYAm-00-OD-07-7626153', description: 'Numeric prefix instead of region code' },
    //     { registrationnumber: 'UDYAm-i-OD-xy-7626153', description: 'Alphabetic digits in the number section' },
        { registrationnumber: 'UDYAm-i-OD-00-7626153', description: 'Region code leading zero issue' },
        { registrationnumber: 'UDYAm-i-OD-07-0000000', description: 'All zeros in the registration number' },
        { registrationnumber: 'UDYAm-i-OD-07-1234567', description: 'Valid format but sequential digits' },
        { registrationnumber: 'UDYAm-i-OD-07-7777777', description: 'All same digits in the registration number' },
    //    { registrationnumber: '', description: 'Blank input' },
        ...
        // { registrationnumber: 7626153, description: 'Excessively Large Number' }


        //Udyam registration test cases
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'Udyam Assist Verification');
