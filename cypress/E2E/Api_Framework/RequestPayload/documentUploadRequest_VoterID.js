...
describe('Test VoterID document upload request API with valid data', () => {
    let apiData;
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'VoterID document upload');
    ...
    filteredTestCases.forEach((testCase) => {
        it(`verify ${testCase.name} API with valid data`, () => {
            ...
            if (payLoad) {
                ...
                const filePaths = {
                    frontPage: 'Voter_Front.jpeg',
                    backPage: 'Voter_Back.jpeg',
                };
                const payload = JSON.stringify({ documentType: 'voterId' }); // Adjust payload as needed
