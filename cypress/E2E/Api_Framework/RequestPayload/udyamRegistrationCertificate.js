...
describe(`Test Udyam Registration Certificate API`, () => {
    let apiData;
    before(function() {
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'Udyam Registration Certificate');
    filteredTestCases.forEach((testCase) => {
        invalidregistrationnumber.forEach((invalidCase) => {                                                        
           it(`Verify the ${testCase.name} API when provided ${invalidCase.description} Udyam Registration Certificate number: ${invalidCase.registrationnumber}`, () => {
