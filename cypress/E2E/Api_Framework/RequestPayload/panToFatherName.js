...
describe(`Test Pan to Father name API`, () => {
    let apiData;
    before(function() {
    ...
    //    { pan: '\u0042\u0044\u0044\u0050\u004A\u0035\u0033\u0034\u0033\u004E',applicatrionId: 'KYC-Automation', description: ' Unicode PAN' },
    ...
    const errorCodeToMessage = {
        ...
        'EPP1555':'This PAN is not registered to an individual.Please provide a valid individual PAN.'
    };


    const filteredTestCases = testCases.filter(testCase => testCase.name === 'Pan to father name');
