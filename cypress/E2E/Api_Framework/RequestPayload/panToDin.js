...
describe(`Test pan to din API`, () => {
    ...
    const invalidPANNumbers = [
        ...
        { pan: 'ADNPG4165', description: 'Too Short PAN' },
    ...
    //    { pan: '\u0041\u0041\u0044\u0043\u0052\u0032\u0032\u0032\u0034\u0048', description: ' Unicode PAN' },
        ...
        { pan: 'ADNPG4165E'*10, description: 'Boundary Testing PAN' },
        { pan: '../../ADNPG4165E', description: 'Basic Directory Traversal Payload in PAN' },
        { pan: 'ADNPG4165EEE', description: 'Too Long PAN' },
    //    { pan: 'ayipm8112b', description: 'PAN with Lowercase Letters' },
        { pan: 'AAADD4165E', description: 'Missing Alphabet Characters' },
        { pan: 'AAAAAR22H', description: 'Missing Numeric Characters' },
        { pan: 'ADNP@4165E', description: 'PAN with Special Characters' },
        { pan: ' ADNPG4165E', description: 'PAN with Leading Space' },
        { pan: 'ADNPG4165E ', description: 'PAN with Trailing Space' },
        { pan: 'ADN PG4 165 E', description: 'PAN with Embedded Space' },
        { pan: '14NPG4165E', description: 'Numeric Characters in Place of Letters' },
        { pan: 'ADNPGDAFEE', description: 'Alphabetic Characters in Place of Numbers' },
       // { pan: 'AAAAA1111A', description: 'Repeated Characters' },
        ...
        { pan: 'ADNPG  4165E', description: 'PAN with Extra Spaces' },
        { pan: '', description: 'Empty PAN' },
        { pan: 'ADNPG*4165E', description: 'Non-Alphanumeric Characters in PAN' },        
    ...
    const filteredTestCases = testCases.filter(testCase => testCase.name === 'pan to din');
