...
describe(`Test API's with Blank string value of "clientSecret" Header`, () => {
    let apiData;
    before(function() {
        cy.fixture('apiData').then((data) => {
            data.headers.clientSecret = "";
    ...
    testCases.forEach((testCase) => {
        it(`Verify ${testCase.name} API with blank string value of "clientSecret" header`, () => {
