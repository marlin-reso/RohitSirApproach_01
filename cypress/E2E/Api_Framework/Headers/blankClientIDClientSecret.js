...
describe(`Test API's with Blank Client ID and Client secret Headers`, () => {
    let apiData;
    before(function() {
        cy.fixture('apiData').then((data) => {
            data.headers.clientId = null;
    ...
    testCases.forEach((testCase) => {
        it(`Verify ${testCase.name} API with blank Client ID and Client Secret headers`, () => {
