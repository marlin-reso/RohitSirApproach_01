...
describe(`Test API's with invalid header "clientId" as "clientId1"`, () => {
    let apiData;
    before(function() {
        cy.fixture('apiData').then((data) => {
            data.headers.clientId1 = data.headers.clientId;
    ...
    testCases.forEach((testCase) => {
        it(`Verify ${testCase.name} API with invalid header "clientId" as "clientId1"`, () => {
