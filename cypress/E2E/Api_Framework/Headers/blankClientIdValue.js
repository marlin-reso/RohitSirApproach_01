...
describe(`Test API's with Blank string value of "clientId" Header`, () => {
    let apiData;
    before(function() {
        cy.fixture('apiData').then((data) => {
            data.headers.clientId = "";
    ...
    testCases.forEach((testCase) => {
        it(`Verify ${testCase.name} API with blank string value of "clientId" header`, () => {
