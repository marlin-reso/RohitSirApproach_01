...
describe(`Test API's with invalid header "clientSecret" as "abcd"`, () => {
    let apiData;
    before(function() {
        cy.fixture('apiData').then((data) => {
            data.headers.clientSecret = "abcd";
    ...
    testCases.forEach((testCase) => {
        it(`Verify ${testCase.name} API with invalid header "clientSecret" as "abcd"`, () => {
