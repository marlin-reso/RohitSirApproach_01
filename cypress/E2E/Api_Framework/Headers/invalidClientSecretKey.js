...
describe(`Test API's with invalid header "clientSecret" as "clientSecret1"`, () => {
    let apiData;
    before(function() {
        cy.fixture('apiData').then((data) => {
            data.headers.clientSecret1 = data.headers.clientSecret;
            delete data.headers.clientSecret; 
            apiData = data;
        });
    });

    testCases.forEach((testCase) => {
        it(`Verify ${testCase.name} API with invalid header "clientSecret" as "clientSecret1"`, () => {
